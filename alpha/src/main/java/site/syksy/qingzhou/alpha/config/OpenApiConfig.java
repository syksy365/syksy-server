...
public class OpenApiConfig implements WebMvcConfigurer {
    ...
    public GroupedOpenApi createSecurityApi() {
        return GroupedOpenApi.builder()
                .group("安全")
                .packagesToScan("site.syksy.qingzhou.security")
                .build();
    }
    ...
    public GroupedOpenApi createGeneratorApi() {
        return GroupedOpenApi.builder()
                .group("辅助开发")
                .packagesToScan("site.syksy.qingzhou.generator")
                .build();
    }
    ...
    public GroupedOpenApi createDatabaseApi() {
        return GroupedOpenApi.builder()
                .group("数据库")
                .packagesToScan("site.syksy.qingzhou.database")
                .build();
    }
    ...
    public GroupedOpenApi createConfigApi() {
        return GroupedOpenApi.builder()
                .group("设置")
                .packagesToScan("site.syksy.qingzhou.setting")
                .build();
    }
    ...
    public GroupedOpenApi createUpmsApi() {
        return GroupedOpenApi.builder()
                .group("账户权限")
                .packagesToScan("site.syksy.qingzhou.upms")
                .build();
    }
    ...
    public GroupedOpenApi createFileApi() {
        return GroupedOpenApi.builder()
                .group("文件管理")
                .packagesToScan("site.syksy.qingzhou.file")
                .build();
    }
    ...
    public GroupedOpenApi createGlobalFileApi() {
        return GroupedOpenApi.builder()
                .group("全局文件管理")
                .packagesToScan("site.syksy.qingzhou.global.file")
                .build();
    }
