...
import site.syksy.qingzhou.upms.domain.vo.CurrentUserVO;
import site.syksy.qingzhou.upms.domain.vo.MiniProgramCodeVO;
import site.syksy.qingzhou.upms.domain.vo.PasswordVO;
import site.syksy.qingzhou.upms.domain.vo.UserVO;
import site.syksy.qingzhou.upms.service.OrgService;
import site.syksy.qingzhou.upms.service.RoleService;
import site.syksy.qingzhou.upms.service.UserRoleService;
...
public class UserController {
    ...
    public CurrentUserVO getCurrentUser(@Parameter(hidden = true) @UserId String userId) {
        ...
        List<site.syksy.qingzhou.upms.domain.vo.Tag> tags = new ArrayList<>();
        site.syksy.qingzhou.upms.domain.vo.Tag tag = new site.syksy.qingzhou.upms.domain.vo.Tag();
        tag.setKey("1");
        tag.setLabel("机智");
        tags.add(tag);
